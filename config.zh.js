...
const USER_CONFIG_ZH = {
  ...
  keyResearch: [
    ...
    },
    {
      ...
      authors: '翁百成<sup>#</sup>、<strong>宋志龙<sup>#</sup></strong>、朱日龙、颜清宇、孙庆德、Corey G Grice、Yanfa Yan、尹万健',
...
本科期间，我把 <a href="https://assettocorsa.gg/" target="_blank">神力科莎（Assetto Corsa）</a>、<a href="https://forza.net/" target="_blank">极限竞速（Forza Motorsport）</a>和 <a href="https://www.iracing.com/" target="_blank">iRacing</a> 这类模拟赛车当作放松方式，也在这些游戏的线上比赛中拿过多次冠军或杆位，读研之后便从竞技模拟赛车中<strong>退役</strong>了。这些经历让我学会毫无畏惧地面对竞争——即便面对激烈的竞争和压力，我依然保持 100 分的信心，全力以赴地争取机会，而不去纠结结果。
<br><br>
...
我的单球准度还算可以，走位上通常也清楚该走什么线路、该击打白球的哪个点位，只是力度常常拿捏不准。
高中和本科期间我每周都会打球，读研和读博之后频率降到了最多每月一次，不过斯诺克赛事我一直看得很勤。这项运动让我体会到精准、策略与耐心的重要性，这些品质在科研中同样受用。`,
    },
    {
      name: "羽毛球",
      icon: "badminton",
