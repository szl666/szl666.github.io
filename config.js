  ...
  keyResearch: [
    {
      ...
      authors: "<strong>Zhilong Song</strong>, Zongmin Zhang, Lixue Cheng",
      abstract: "Theoretical catalysis promises rapid catalyst discovery, yet machine-learning predictions often deviate from experiment and stay confined to narrow material families for lack of a faithful, condition-aware simulator. We present CatDT (Catalysis Digital Twin), a self-evolving multi-agent system that builds an autonomous digital twin of a working catalyst. From a bulk crystal and a natural-language reaction description, eight agents and 27 tools predict facets, reconstruct surfaces, rank pathways, locate transition states, and compute kinetics in 5–30 min on one GPU. Two innovations are decisive. UniMech builds and prunes the reaction network for any reaction on any surface, finding dominant pathways at over 10³× lower cost than exhaustive enumeration. A memory-augmented reinforcement loop then automates barrier calculation, learning from each NEB success and failure to lift its success rate from 41% to 84% across 600 surfaces. Across seven benchmarks every prediction lies within 0.5–2 times experiment over four orders of magnitude. Deployed as a design engine, CatDT proposes non-precious propane-dehydrogenation catalysts that rival the platinum benchmark, including a Ni@ZrO₂ overlayer at a simulated propylene turnover frequency of 1.63 s⁻¹ and ~100% selectivity. CatDT thus demonstrates that scientific reliability comes not from raw model capability but from the engineered harness around it: deterministic tools, persistent memory, and verified self-improvement.",
    },
    {
    ...
    },
    {
      ...
      authors: "<strong>Zhilong Song</strong>, Qionghua Zhou, Chongyi Ling, Qiang Li, Lixue Cheng, Jinlan Wang",
...
Throughout my undergraduate years, I enjoyed racing simulators like <a href="https://assettocorsa.gg/" target="_blank">Assetto Corsa</a>, <a href="https://forza.net/" target="_blank">Forza Motorsport</a>, and <a href="https://www.iracing.com/" target="_blank">iRacing</a> for relaxation, took multiple wins and pole positions in their online races, and <strong>retired</strong> from competitive sim racing after starting my master's degree. These experiences have taught me to embrace competition fearlessly - even when facing intense competition and pressure, I maintain 100% confidence and give my all to pursue opportunities, regardless of the outcome.
<br><br>
