...
const USER_CONFIG = {
  ...
  bio: `I work at the frontier where <span class="highlight">artificial intelligence</span> meets <span class="highlight">materials science</span>. A central challenge in this field is venturing beyond known structures to create entirely new ones with exceptional properties. To address this, I develop new generative models for the inverse design of stable functional materials, optimization frameworks that steer these generative models to explore vast property landscapes toward desired targets, autonomous agents that assess whether predicted structures can be synthesized and recommend viable synthetic routes, and interpretable machine learning methods that reveal the mechanistic origins of material performance.`,

  bioExtra: `These efforts have resulted in 21 peer-reviewed publications with an h-index of <span id="h_index_intro" class="highlight">12</span> and total <span id="total_citations_bio" class="highlight">citations</span>. Among them, 8 are first-authored — including 3 in Nature Communications, 1 in Materials Horizons, 1 in Advanced Functional Materials, and 1 in The Journal of Physical Chemistry Letters — with two additional first-authored preprints currently under review.`,
